...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="bg-gradient-to-b from-brand-grey-light/20 to-brand-white py-20 md:py-32 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 opacity-15">
        <div className="absolute top-20 left-20 w-72 h-72 bg-brand-purple-light/30 rounded-full blur-3xl animate-pulse-slow"></div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {categories.map((category, index) => (
            <div
              ...
              className="group relative cursor-pointer overflow-hidden bg-brand-grey-light/40 shadow-xl transition-all duration-500 transform hover:-translate-y-4 border border-brand-grey/50 hover:border-brand-purple-light"
            >
