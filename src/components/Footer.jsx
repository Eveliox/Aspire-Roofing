...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-purple-dark to-black border-t border-magenta-bright/30 py-16 md:py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {areas.map((area, index) => (
                <li key={index} className="flex items-center text-white/90 hover:text-magenta-bright transition-colors group">
          ...
          {/* Right: Contact */}
          <div className="bg-gradient-to-br from-magenta-bright/20 to-magenta-accent/10 backdrop-blur-md rounded-3xl p-8 border border-magenta-bright/40 shadow-2xl">
            ...
            <div className="space-y-4">
              <div className="flex items-center text-white/90 group">
                ...
                <a href="tel:7866566098" className="hover:text-magenta-bright transition-colors font-semibold text-lg">
                  786-656-6098
                </a>
              </div>
              <div className="flex items-center text-white/90 group">
