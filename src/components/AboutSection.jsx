...
const AboutSection = () => {
  return (
    <section 
      id="about"
      className="relative py-20 md:py-32 bg-brand-white overflow-hidden"
      style={{
    ...
    >
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-brand-white-off/30 via-brand-white to-brand-white-off/40"></div>

      {/* Accent lights */}
      <div className="absolute inset-0 opacity-15">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-brand-purple/30 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-brand-purple/25 rounded-full blur-3xl" style={{ animationDelay: '1.5s' }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
          {/* Mission Card */}
          <div className="bg-brand-white-off/80 backdrop-blur-md p-10 border border-brand-charcoal/50 hover:border-brand-purple transition-all duration-500 hover:bg-brand-white hover:shadow-2xl hover:shadow-brand-purple/20 transform hover:-translate-y-2">
            <div className="text-brand-purple mb-6">
              <svg className="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="text-2xl md:text-3xl font-extrabold text-brand-black mb-5 uppercase tracking-wide">OUR MISSION</h3>
            <p className="text-brand-black/80 leading-relaxed text-base md:text-lg font-light">
          ...
          <div className="bg-brand-white-off/80 backdrop-blur-md p-10 border border-brand-charcoal/50 hover:border-brand-purple transition-all duration-500 hover:bg-brand-white hover:shadow-2xl hover:shadow-brand-purple/20 transform hover:-translate-y-2">
            ...
            <h3 className="text-2xl md:text-3xl font-extrabold text-brand-black mb-5 uppercase tracking-wide">OUR INNOVATION</h3>
            <p className="text-brand-black/80 leading-relaxed text-base md:text-lg font-light">
          ...
          <div className="bg-brand-white-off/80 backdrop-blur-md p-10 border border-brand-charcoal/50 hover:border-brand-purple transition-all duration-500 hover:bg-brand-white hover:shadow-2xl hover:shadow-brand-purple/20 transform hover:-translate-y-2">
            ...
            <h3 className="text-2xl md:text-3xl font-extrabold text-brand-black mb-5 uppercase tracking-wide">RELIABLE SUPPORT</h3>
            <p className="text-brand-black/80 leading-relaxed text-base md:text-lg font-light">
